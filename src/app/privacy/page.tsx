        ...
        <article className="space-y-8 text-sm md:text-base text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p className="text-zinc-400">
              <strong className="text-zinc-200">Product Analytics & Telemetry:</strong> We utilize Google Analytics 4 (GA4) to analyze traffic patterns, page views, and feature interactions. Google Analytics captures pseudonymous usage metrics mapped strictly to anonymous identifiers. We do <strong>not</strong> share your full name, email address, or personal identifying information (PII) with analytics providers.
            </p>
          </section>
