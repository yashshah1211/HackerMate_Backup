-- Migration: 202608040003_add_reply_to_id_to_messages
-- Adds reply_to_id foreign key column to public.messages and updates send_message functions.

ALTER TABLE public.messages
ADD COLUMN IF NOT EXISTS reply_to_id UUID REFERENCES public.messages(id) ON DELETE SET NULL;

-- Update public.send_message to accept p_reply_to_id
...
-- Update public.send_message_with_mentions to accept p_reply_to_id
